...
var pickName = function() {
  ...
  if (choices.length > 1) {
    ...
    Swal.fire({
      ...
      <div style="top:75px;text-shadow:2px 2px 5px black;text-transform:uppercase;font-size:60px;color:white;font-weight:bold;margin-top:0%;position:relative;left:-100%;width:300%">${name}</div> 
      <br>
      </div>
      `,
